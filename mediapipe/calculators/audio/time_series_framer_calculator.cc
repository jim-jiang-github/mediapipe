...
abslx::Status TimeSeriesFramerCalculator::Process(CalculatorContext* cc) {
...
abslx::Status TimeSeriesFramerCalculator::Close(CalculatorContext* cc) {
...
abslx::Status TimeSeriesFramerCalculator::Open(CalculatorContext* cc) {
