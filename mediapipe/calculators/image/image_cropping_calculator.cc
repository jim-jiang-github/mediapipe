...
abslx::Status ImageCroppingCalculator::GetContract(CalculatorContract* cc) {
...
abslx::Status ImageCroppingCalculator::Open(CalculatorContext* cc) {
...
abslx::Status ImageCroppingCalculator::Process(CalculatorContext* cc) {
...
abslx::Status ImageCroppingCalculator::Close(CalculatorContext* cc) {
#if !MEDIAPIPE_DISABLE_GPU
...
abslx::Status ImageCroppingCalculator::ValidateBorderModeForCPU(
    CalculatorContext* cc) {
  int border_mode;
  return GetBorderModeForOpenCV(cc, &border_mode);
}

abslx::Status ImageCroppingCalculator::ValidateBorderModeForGPU(
    CalculatorContext* cc) {
...
abslx::Status ImageCroppingCalculator::RenderCpu(CalculatorContext* cc) {
...
abslx::Status ImageCroppingCalculator::RenderGpu(CalculatorContext* cc) {
...
abslx::Status ImageCroppingCalculator::InitGpu(CalculatorContext* cc) {
#if !MEDIAPIPE_DISABLE_GPU
...
abslx::Status ImageCroppingCalculator::GetBorderModeForOpenCV(
