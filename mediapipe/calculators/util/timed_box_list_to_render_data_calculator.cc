...
abslx::Status TimedBoxListToRenderDataCalculator::GetContract(
...
abslx::Status TimedBoxListToRenderDataCalculator::Open(CalculatorContext* cc) {
...
abslx::Status TimedBoxListToRenderDataCalculator::Process(
