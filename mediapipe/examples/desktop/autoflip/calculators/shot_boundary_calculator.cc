...
abslx::Status ShotBoundaryCalculator::Open(mediapipe::CalculatorContext* cc) {
...
abslx::Status ShotBoundaryCalculator::Process(mediapipe::CalculatorContext* cc) {
...
abslx::Status ShotBoundaryCalculator::GetContract(
