...
class SceneCameraMotionAnalyzer {
 public:
  ...
  abslx::Status AnalyzeSceneAndPopulateFocusPointFrames(
 ...
 protected:
  ...
  abslx::Status DecideCameraMotionType(
      const KeyFrameCropOptions& key_frame_crop_options,
  ...
  abslx::Status PopulateFocusPointFrames(
 ...
 private:
  ...
  abslx::Status DecideSteadyLookAtRegion(
      const KeyFrameCropOptions& key_frame_crop_options,
      SceneKeyFrameCropSummary* scene_summary,
      SceneCameraMotion* scene_camera_motion) const;
  ...
  abslx::Status AddFocusPointsFromCenterTypeAndWeight(
  ...
  abslx::Status PopulateFocusPointFramesForTracking(
      const SceneKeyFrameCropSummary& scene_summary,
  ...
  abslx::Status ToUseSteadyMotion(const float look_at_center_x,
  ...
  abslx::Status ToUseSweepingMotion(
