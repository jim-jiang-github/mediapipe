...
class InputStreamManagerTest : public ::testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    input_stream_manager_ = abslx::make_unique<InputStreamManager>();
...
TEST_F(InputStreamManagerTest, BackwardsInTime) {
  ...
  notify_ = false;
  abslx::Status result = input_stream_manager_->SetNextTimestampBound(
