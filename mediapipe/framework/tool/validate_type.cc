...
namespace tool {
abslx::Status RunGeneratorFillExpectations(
  ...
  return tool::CombinedStatus(
      abslx::StrCat(config.packet_generator(), "::FillExpectations failed: "),
      statuses);
}

abslx::Status RunGenerateAndValidateTypes(
  ...
  MP_RETURN_IF_ERROR(tool::CombinedStatus(
      abslx::StrCat(packet_generator_name, "::FillExpectations failed: "),
      statuses));
