...
class NodeTypeInfo {
 public:
  ...
  const abslx::flat_hash_set<int>& AncestorSources() const {
 ...
 private:
  ...
  abslx::flat_hash_set<int> ancestor_sources_;
};
...
class ValidatedGraphConfig {
 public:
  ...
  template <typename T>
  abslx::Status CanAcceptSidePackets(
  ...
  abslx::StatusOr<std::string> RegisteredSidePacketTypeName(
  ...
  abslx::StatusOr<std::string> RegisteredStreamTypeName(const std::string& name);
 ...
 private:
  ...
  abslx::Status PerformBasicTransforms(
  ...
  abslx::Status InitializeGeneratorInfo();
  // Initialize the Calculator information.
  abslx::Status InitializeCalculatorInfo();
  // Initialize the StatusHandler information.
  abslx::Status InitializeStatusHandlerInfo();
  ...
  abslx::Status InitializeSidePacketInfo(bool* need_sorting_ptr);
  ...
  abslx::Status AddInputSidePacketsForNode(NodeTypeInfo* node_type_info);
  ...
  abslx::Status AddOutputSidePacketsForNode(NodeTypeInfo* node_type_info,
  ...
  // packet).
  abslx::Status InitializeStreamInfo(bool* need_sorting_ptr);
  abslx::Status AddOutputStreamsForNode(NodeTypeInfo* node_type_info);
  abslx::Status AddInputStreamsForNode(NodeTypeInfo* node_type_info,
                                      bool* need_sorting_ptr);
  // A helper function for adding a single output stream EdgeInfo.
  abslx::Status AddOutputStream(NodeTypeInfo::NodeRef node,
                               const std::string& name,
  ...
  abslx::Status ValidateExecutors();
...
template <typename T>
abslx::Status ValidatedGraphConfig::CanAcceptSidePackets(
    const std::map<std::string, T>& side_packets) const {
