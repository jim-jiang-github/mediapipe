...
abslx::StatusOr<abslx::string_view> CheckAndLoadFirstAssociatedFile(
  ...
  ASSIGN_OR_RETURN(abslx::string_view vocab_buffer,
...
abslx::StatusOr<std::unique_ptr<Tokenizer>> CreateTokenizerFromProcessUnit(
  ...
  switch (tokenizer_process_unit->options_type()) {
    ...
    case tflite::ProcessUnitOptions_SentencePieceTokenizerOptions: {
      ...
      ASSIGN_OR_RETURN(abslx::string_view model_buffer,
    ...
    default:
      return CreateStatusWithPayload(
          ...
          abslx::StrCat("Incorrect options_type:",
