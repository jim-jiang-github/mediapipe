...
TEST_F(CommandLineFlagTest, TestAttributesAccessMethods) {
  auto* flag_01 = abslx::FindCommandLineFlag("int_flag");
  ...
  EXPECT_TRUE(abslx::EndsWith(flag_01->Filename(),
                             "absl/flags/commandlineflag_test.cc"))
      << flag_01->Filename();

  auto* flag_02 = abslx::FindCommandLineFlag("string_flag");
  ...
  EXPECT_TRUE(abslx::EndsWith(flag_02->Filename(),
                             "absl/flags/commandlineflag_test.cc"))
      << flag_02->Filename();
}
...
TEST_F(CommandLineFlagTest, TestValueAccessMethods) {
  abslx::SetFlag(&FLAGS_int_flag2, 301);
  auto* flag_01 = abslx::FindCommandLineFlag("int_flag2");

  ASSERT_TRUE(flag_01);
  EXPECT_EQ(flag_01->CurrentValue(), "301");
  EXPECT_EQ(flag_01->DefaultValue(), "201");

  abslx::SetFlag(&FLAGS_string_flag2, "new_str_value");
  auto* flag_02 = abslx::FindCommandLineFlag("string_flag2");
...
TEST_F(CommandLineFlagTest, TestParseFromCurrentValue) {
  ...
  EXPECT_EQ(abslx::GetFlag(FLAGS_int_flag), 11);
  EXPECT_FALSE(
      flags::PrivateHandleAccessor::IsSpecifiedOnCommandLine(*flag_01));
  ...
  EXPECT_TRUE(flags::PrivateHandleAccessor::ParseFrom(
      *flag_01, "-123", flags::SET_FLAGS_VALUE, flags::kProgrammaticChange,
      err));
  EXPECT_EQ(abslx::GetFlag(FLAGS_int_flag), -123);
  EXPECT_FALSE(
      flags::PrivateHandleAccessor::IsSpecifiedOnCommandLine(*flag_01));
  ...
  EXPECT_TRUE(flags::PrivateHandleAccessor::ParseFrom(
      *flag_01, "0x10", flags::SET_FLAGS_VALUE, flags::kProgrammaticChange,
      err));
  EXPECT_EQ(abslx::GetFlag(FLAGS_int_flag), 16);
  EXPECT_FALSE(
      flags::PrivateHandleAccessor::IsSpecifiedOnCommandLine(*flag_01));
  ...
  EXPECT_TRUE(flags::PrivateHandleAccessor::ParseFrom(
      *flag_02, "xyz", flags::SET_FLAGS_VALUE, flags::kProgrammaticChange,
      err));
  EXPECT_EQ(abslx::GetFlag(FLAGS_string_flag), "xyz");

  EXPECT_TRUE(flags::PrivateHandleAccessor::ParseFrom(
      *flag_02, "", flags::SET_FLAGS_VALUE, flags::kProgrammaticChange, err));
  EXPECT_EQ(abslx::GetFlag(FLAGS_string_flag), "");
}
...
TEST_F(CommandLineFlagTest, TestParseFromIfDefault) {
  ...
  EXPECT_TRUE(flags::PrivateHandleAccessor::ParseFrom(
      *flag_01, "22", flags::SET_FLAG_IF_DEFAULT, flags::kProgrammaticChange,
      err))
      << err;
  EXPECT_EQ(abslx::GetFlag(FLAGS_int_flag), 22);
  ...
  EXPECT_TRUE(flags::PrivateHandleAccessor::ParseFrom(
      *flag_01, "33", flags::SET_FLAG_IF_DEFAULT, flags::kProgrammaticChange,
      err));
  EXPECT_EQ(abslx::GetFlag(FLAGS_int_flag), 201);
