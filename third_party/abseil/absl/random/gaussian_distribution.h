...
// abslx::gaussian_distribution implements the Ziggurat algorithm
...
// abslx::gaussian_distribution_base implements the underlying ziggurat algorithm
  ...
  class param_type {
   ...
   private:
    ...
    static_assert(
        ...
        "Class-template abslx::gaussian_distribution<> must be parameterized "
