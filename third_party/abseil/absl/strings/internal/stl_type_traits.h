...
template <typename C, template <typename...> class T>
using IsSpecialization = IsSpecializationImpl<abslx::decay_t<C>, T>;
...
template <typename C>
using IsArray = IsArrayImpl<abslx::decay_t<C>>;
...
template <typename C>
using IsBitset = IsBitsetImpl<abslx::decay_t<C>>;
...
struct IsBaseOfSpecializationImpl<
    C, T, abslx::void_t<typename C::value_type, typename C::allocator_type>>
    : std::is_base_of<C,
                      T<typename C::value_type, typename C::allocator_type>> {};
template <typename C, template <typename, typename, typename> class T>
struct IsBaseOfSpecializationImpl<
    C, T,
    abslx::void_t<typename C::key_type, typename C::key_compare,
...
struct IsBaseOfSpecializationImpl<
    C, T,
    abslx::void_t<typename C::key_type, typename C::mapped_type,
...
struct IsBaseOfSpecializationImpl<
    C, T,
    abslx::void_t<typename C::key_type, typename C::hasher,
...
struct IsBaseOfSpecializationImpl<
    ...
    : std::is_base_of<C, T<typename C::key_type, typename C::mapped_type,
                           ...
                           typename C::allocator_type>> {};
template <typename C, template <typename...> class T>
using IsBaseOfSpecialization = IsBaseOfSpecializationImpl<abslx::decay_t<C>, T>;
...
template <typename C>
using IsBaseOfArray = IsBaseOfArrayImpl<abslx::decay_t<C>>;
...
template <typename C>
using IsBaseOfBitset = IsBaseOfBitsetImpl<abslx::decay_t<C>>;

template <typename C>
struct IsBaseOfSTLContainer
    : abslx::disjunction<IsBaseOfArray<C>, IsBaseOfBitset<C>,
...
using IsConvertibleToSpecialization =
    IsConvertibleToSpecializationImpl<abslx::decay_t<C>, T>;
...
template <typename C>
using IsConvertibleToArray = IsConvertibleToArrayImpl<abslx::decay_t<C>>;
...
template <typename C>
using IsConvertibleToBitset = IsConvertibleToBitsetImpl<abslx::decay_t<C>>;
...
struct IsStrictlyBaseOfAndConvertibleToSTLContainer
    : abslx::conjunction<abslx::negation<IsSTLContainer<C>>,
