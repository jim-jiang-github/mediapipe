...
struct VariantAccessResultImpl<I, Variantemplate<T...>&> {
  using type = typename abslx::variant_alternative<I, variant<T...>>::type&;
};

template <std::size_t I, template <class...> class Variantemplate, class... T>
struct VariantAccessResultImpl<I, const Variantemplate<T...>&> {
  using type =
      const typename abslx::variant_alternative<I, variant<T...>>::type&;
};
...
struct VisitIndicesResultImpl {
  using type = abslx::result_of_t<Op(AlwaysZero<Vs>...)>;
};
...
constexpr ReturnType call_with_indices(FunctionObject&& function) {
  ...
  return abslx::forward<FunctionObject>(function)(SizeT<Indices>()...);
}
...
struct MakeVisitationMatrix<ReturnType, FunctionObject,
    ...
    : MakeVisitationMatrixImpl<ReturnType, FunctionObject,
                               ...
                               abslx::make_index_sequence<HeadEndIndex>,
                               index_sequence<BoundIndices...>> {};
...
struct UnreachableSwitchCase {
  ...
  [[noreturn]] static VisitIndicesResultT<Op, std::size_t> Run(
    ...
    return Run(abslx::forward<Op>(op));
...
struct ReachableSwitchCase {
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op) {
    return abslx::base_internal::invoke(abslx::forward<Op>(op), SizeT<I>());
  }
};
...
[[noreturn]] ReturnType TypedThrowBadVariantAccess() {
  abslx::variant_internal::ThrowBadVariantAccess();
}
...
struct VisitIndicesSwitch {
  ...
  static VisitIndicesResultT<Op, std::size_t> Run(Op&& op, std::size_t i) {
    switch (i) {
      case 0:
        return PickCase<Op, 0, EndIndex>::Run(abslx::forward<Op>(op));
      case 1:
        return PickCase<Op, 1, EndIndex>::Run(abslx::forward<Op>(op));
      case 2:
        return PickCase<Op, 2, EndIndex>::Run(abslx::forward<Op>(op));
      case 3:
        return PickCase<Op, 3, EndIndex>::Run(abslx::forward<Op>(op));
      case 4:
        return PickCase<Op, 4, EndIndex>::Run(abslx::forward<Op>(op));
      case 5:
        return PickCase<Op, 5, EndIndex>::Run(abslx::forward<Op>(op));
      case 6:
        return PickCase<Op, 6, EndIndex>::Run(abslx::forward<Op>(op));
      case 7:
        return PickCase<Op, 7, EndIndex>::Run(abslx::forward<Op>(op));
      case 8:
        return PickCase<Op, 8, EndIndex>::Run(abslx::forward<Op>(op));
      case 9:
        return PickCase<Op, 9, EndIndex>::Run(abslx::forward<Op>(op));
      case 10:
        return PickCase<Op, 10, EndIndex>::Run(abslx::forward<Op>(op));
      case 11:
        return PickCase<Op, 11, EndIndex>::Run(abslx::forward<Op>(op));
      case 12:
        return PickCase<Op, 12, EndIndex>::Run(abslx::forward<Op>(op));
      case 13:
        return PickCase<Op, 13, EndIndex>::Run(abslx::forward<Op>(op));
      case 14:
        return PickCase<Op, 14, EndIndex>::Run(abslx::forward<Op>(op));
      case 15:
        return PickCase<Op, 15, EndIndex>::Run(abslx::forward<Op>(op));
      case 16:
        return PickCase<Op, 16, EndIndex>::Run(abslx::forward<Op>(op));
      case 17:
        return PickCase<Op, 17, EndIndex>::Run(abslx::forward<Op>(op));
      case 18:
        return PickCase<Op, 18, EndIndex>::Run(abslx::forward<Op>(op));
      case 19:
        return PickCase<Op, 19, EndIndex>::Run(abslx::forward<Op>(op));
      case 20:
        return PickCase<Op, 20, EndIndex>::Run(abslx::forward<Op>(op));
      case 21:
        return PickCase<Op, 21, EndIndex>::Run(abslx::forward<Op>(op));
      case 22:
        return PickCase<Op, 22, EndIndex>::Run(abslx::forward<Op>(op));
      case 23:
        return PickCase<Op, 23, EndIndex>::Run(abslx::forward<Op>(op));
      case 24:
        return PickCase<Op, 24, EndIndex>::Run(abslx::forward<Op>(op));
      case 25:
        return PickCase<Op, 25, EndIndex>::Run(abslx::forward<Op>(op));
      case 26:
        return PickCase<Op, 26, EndIndex>::Run(abslx::forward<Op>(op));
      case 27:
        return PickCase<Op, 27, EndIndex>::Run(abslx::forward<Op>(op));
      case 28:
        return PickCase<Op, 28, EndIndex>::Run(abslx::forward<Op>(op));
      case 29:
        return PickCase<Op, 29, EndIndex>::Run(abslx::forward<Op>(op));
      case 30:
        return PickCase<Op, 30, EndIndex>::Run(abslx::forward<Op>(op));
      case 31:
        return PickCase<Op, 31, EndIndex>::Run(abslx::forward<Op>(op));
      case 32:
        return PickCase<Op, 32, EndIndex>::Run(abslx::forward<Op>(op));
      default:
        ABSL_ASSERT(i == variant_npos);
        return abslx::base_internal::invoke(abslx::forward<Op>(op), NPos());
    }
  }
};
...
struct VisitIndicesVariadicImpl<abslx::index_sequence<N...>, EndIndices...> {
  ...
  static VisitIndicesResultT<Op, decltype(EndIndices)...> Run(
    ...
    return VisitIndicesSwitch<NumCasesOfSwitch<EndIndices...>::value>::Run(
        FlattenedOp<Op>{abslx::forward<Op>(op)},
...
struct VisitIndicesVariadic
    : VisitIndicesVariadicImpl<abslx::make_index_sequence<sizeof...(EndIndices)>,
                               EndIndices...> {};
...
template <std::size_t... EndIndices>
struct VisitIndices
    : abslx::conditional_t<(NumCasesOfSwitch<EndIndices...>::value <=
...
struct VisitIndices<EndIndex>
    : abslx::conditional_t<(EndIndex <= MaxUnrolledVisitCases),
...
struct VariantCoreAccess {
  ...
  static void Destroy(VariantType& self) {  // NOLINT
    ...
    self.index_ = abslx::variant_npos;
  }
  ...
  static void InitFrom(Variant& self, Variant&& other) {  // NOLINT
    VisitIndices<abslx::variant_size<Variant>::value>::Run(
  ...
  static VariantAccessResult<I, Variant> CheckedAccess(Variant&& self) {
    ...
    return Access<I>(abslx::forward<Variant>(self));
  }
  ...
  struct MoveAssignVisitor {
    ...
    void operator()(SizeT<abslx::variant_npos> /*new_i*/) const {
      Destroy(*left);
    }
  ...
  struct CopyAssignVisitor {
    ...
    void operator()(SizeT<NewIndex> /*new_i*/) const {
      using New =
          typename abslx::variant_alternative<NewIndex, DerivedType>::type;
  ...
  struct ConversionAssignVisitor {
    ...
    void operator()(SizeT<NewIndex::value> /*old_i*/
      ...
      Access<NewIndex::value>(*left) = abslx::forward<QualifiedNew>(other);
    }
    ...
    void operator()(SizeT<OldIndex> /*old_i*/
      ...
      using New =
          typename abslx::variant_alternative<NewIndex::value, Left>::type;
      if (std::is_nothrow_constructible<New, QualifiedNew>::value ||
          !std::is_nothrow_move_constructible<New>::value) {
        left->template emplace<NewIndex::value>(
            abslx::forward<QualifiedNew>(other));
      } else {
        ...
        left->template emplace<NewIndex::value>(
            New(abslx::forward<QualifiedNew>(other)));
      }
    }
  ...
  MakeConversionAssignVisitor(Left* left, QualifiedNew&& qual) {
    return {left, abslx::forward<QualifiedNew>(qual)};
  }
  ...
  static typename abslx::variant_alternative<NewIndex, Self>::type& Replace(
      Self* self, Args&&... args) {
    Destroy(*self);
    using New = typename abslx::variant_alternative<NewIndex, Self>::type;
    New* const result = ::new (static_cast<void*>(&self->state_))
        New(abslx::forward<Args>(args)...);
...
struct ContainsVariantNPos
    : abslx::negation<std::is_same<  // NOLINT
          abslx::integer_sequence<bool, 0 <= Is...>,
          abslx::integer_sequence<bool, Is != abslx::variant_npos...>>> {};

template <class Op, class... QualifiedVariants>
using RawVisitResult =
    abslx::result_of_t<Op(VariantAccessResult<0, QualifiedVariants>...)>;
...
struct PerformVisitation {
  ...
  constexpr ReturnType operator()(SizeT<Is>... indices) const {
    return Run(typename ContainsVariantNPos<Is...>::type{},
               abslx::index_sequence_for<QualifiedVariants...>(), indices...);
  }
  ...
  constexpr ReturnType Run(std::false_type /*has_valueless*/,
    ...
    static_assert(
        std::is_same<ReturnType,
                     abslx::result_of_t<Op(VariantAccessResult<
                                          Is, QualifiedVariants>...)>>::value,
        "All visitation overloads must have the same return type.");
    return abslx::base_internal::invoke(
        abslx::forward<Op>(op),
        VariantCoreAccess::Access<Is>(
            abslx::forward<QualifiedVariants>(std::get<TupIs>(variant_tup)))...);
  }
...
union Union<Head, Tail...> {
  ...
  explicit constexpr Union(EmplaceTag<0>, P&&... args)
      : head(abslx::forward<P>(args)...) {}

  template <std::size_t I, class... P>
  explicit constexpr Union(EmplaceTag<I>, P&&... args)
      : tail(EmplaceTag<I - 1>{}, abslx::forward<P>(args)...) {}
...
using DestructibleUnion =
    abslx::conditional_t<std::is_destructible<Union<T...>>::value, Union<T...>,
...
class VariantStateBase {
 protected:
  ...
  template <class LazyH = H,
            class ConstructibleH = abslx::enable_if_t<
  ...
  explicit constexpr VariantStateBase(EmplaceTag<I> tag, P&&... args)
      : state_(tag, abslx::forward<P>(args)...), index_(I) {}
...
template <class... T>
using RequireAllHaveEqualT = abslx::enable_if_t<
    abslx::conjunction<is_detected_convertible<bool, EqualResult, T>...>::value,
    bool>;

template <class... T>
using RequireAllHaveNotEqualT =
    abslx::enable_if_t<abslx::conjunction<is_detected_convertible<
...
struct VariantHelper<variant<Ts...>> {
  ...
  struct CanConvertFrom<variant<Us...>>
      : public abslx::conjunction<CanAccept<Us>...> {};
};
...
using VariantStateBaseDestructor =
    abslx::conditional_t<std::is_destructible<Union<T...>>::value,
                        VariantStateBase<T...>,
...
// work around the bug.
template <class... T>
using VariantMoveBase = abslx::conditional_t<
    abslx::disjunction<
        abslx::negation<abslx::conjunction<std::is_move_constructible<T>...>>,
        abslx::conjunction<IsTriviallyMoveConstructible<T>...>>::value,
...
template <class... T>
using VariantCopyBase = abslx::conditional_t<
    abslx::disjunction<
        abslx::negation<abslx::conjunction<std::is_copy_constructible<T>...>>,
        std::is_copy_constructible<Union<T...>>>::value,
    VariantMoveBase<T...>, VariantCopyBaseNontrivial<T...>>;

// Base that is dependent on whether or not the move-assign can be trivial.
template <class... T>
using VariantMoveAssignBase = abslx::conditional_t<
    abslx::disjunction<
        abslx::conjunction<abslx::is_move_assignable<Union<T...>>,
                          std::is_move_constructible<Union<T...>>,
                          std::is_destructible<Union<T...>>>,
        abslx::negation<abslx::conjunction<std::is_move_constructible<T>...,
                                         // Note: We're not qualifying this with
                                         // abslx:: because it doesn't compile
                                         // under MSVC.
...
template <class... T>
using VariantCopyAssignBase = abslx::conditional_t<
    abslx::disjunction<
        abslx::conjunction<abslx::is_copy_assignable<Union<T...>>,
 ...
 protected:
  ...
  struct Destroyer {
    ...
    void operator()(SizeT<I> i) const {
      using Alternative =
          typename abslx::variant_alternative<I, variant<T...>>::type;
      variant_internal::AccessUnion(self->state_, i).~Alternative();
    }

    void operator()(SizeT<abslx::variant_npos> /*i*/) const {
      // This space intentionally left blank
    }
...
class VariantMoveBaseNontrivial : protected VariantStateBaseDestructor<T...> {
 ...
 protected:
  ...
  struct Construct {
    ...
    void operator()(SizeT<I> i) const {
      ...
      ::new (static_cast<void*>(&self->state_)) Alternative(
          variant_internal::AccessUnion(abslx::move(other->state_), i));
    }
  ...
  VariantMoveBaseNontrivial(VariantMoveBaseNontrivial&& other) noexcept(
      abslx::conjunction<std::is_nothrow_move_constructible<T>...>::value)
 ...
 protected:
  ...
  VariantMoveAssignBaseNontrivial& operator=(
    ...
    operator=(VariantMoveAssignBaseNontrivial&& other) noexcept(
        abslx::conjunction<std::is_nothrow_move_constructible<T>...,
...
struct EqualsOp {
  ...
  constexpr bool operator()(SizeT<abslx::variant_npos> /*v_i*/) const {
    return true;
  }
...
struct Swap {
  ...
  void operator()(SizeT<abslx::variant_npos> /*w_i*/) const {
...
struct VariantHashBase<Variant,
                       abslx::enable_if_t<abslx::conjunction<
