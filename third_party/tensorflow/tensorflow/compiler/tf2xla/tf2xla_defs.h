...
inline constexpr abslx::string_view kCompileDeviceTypeAttr =
    "_xla_compile_device_type";
// Marks a node for replication. The attribute value indicates the replication
// metadata op.
inline constexpr abslx::string_view kReplicationInfoAttr = "_replication_info";
...
inline constexpr abslx::string_view kTpuReplicateAttr = "_tpu_replicate";
// Marks a node inside of an XLA compilation cluster to be placed outside of the
// cluster.
inline constexpr abslx::string_view kXlaOutsideCompilationAttr =
    "_xla_outside_compilation";
// Frontend attributes ID.
inline constexpr abslx::string_view kXlaFrontendAttributesAttrName =
    "_XlaFrontendAttributes";
// Device types.
inline constexpr abslx::string_view kCpuDevice = "CPU";
inline constexpr abslx::string_view kGpuDevice = "GPU";
inline constexpr abslx::string_view kTpuDevice = "TPU";
inline constexpr std::array<abslx::string_view, 3> kValidDeviceTypes = {
    kCpuDevice, kGpuDevice, kTpuDevice};
// Attributes that need to be propagated during rewrites (e.g., in
// functionalization).
inline constexpr std::array<abslx::string_view, 5> kAttrsToPropagate = {
