...
KernelLoaderSpec::KernelLoaderSpec(abslx::string_view kernelname)
    : kernelname_(std::string(kernelname)) {}

OnDiskKernelLoaderSpec::OnDiskKernelLoaderSpec(abslx::string_view filename,
                                               abslx::string_view kernelname)
    : KernelLoaderSpec(kernelname), filename_(std::string(filename)) {}

CudaPtxOnDisk::CudaPtxOnDisk(abslx::string_view filename,
                             abslx::string_view kernelname)
    : OnDiskKernelLoaderSpec(filename, kernelname) {}

CudaCubinOnDisk::CudaCubinOnDisk(abslx::string_view filename,
                                 abslx::string_view kernelname)
    : OnDiskKernelLoaderSpec(filename, kernelname) {}
...
CudaPtxInMemory::CudaPtxInMemory(abslx::string_view ptx,
...
CudaPtxInMemory::CudaPtxInMemory(
    ...
    abslx::string_view kernel_name, bool ptx_compressed)
    : KernelLoaderSpec(kernel_name),
      ptx_by_compute_capability_(CompareComputeCapability) {
...
OpenCLTextOnDisk::OpenCLTextOnDisk(abslx::string_view filename,
                                   abslx::string_view kernelname)
    : OnDiskKernelLoaderSpec(filename, kernelname) {}

OpenCLTextInMemory::OpenCLTextInMemory(abslx::string_view text,
                                       abslx::string_view kernelname)
    : KernelLoaderSpec(kernelname), text_(text) {}

OpenCLBinaryOnDisk::OpenCLBinaryOnDisk(abslx::string_view filename,
                                       abslx::string_view kernelname)
    : OnDiskKernelLoaderSpec(filename, kernelname) {}

MultiKernelLoaderSpec *MultiKernelLoaderSpec::AddOpenCLTextOnDisk(
    abslx::string_view filename, abslx::string_view kernelname) {
...
MultiKernelLoaderSpec *MultiKernelLoaderSpec::AddCudaCubinInMemory(
    const char *bytes, abslx::string_view kernelname) {
