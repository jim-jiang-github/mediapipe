...
class KernelLoaderSpec {
 ...
 protected:
  explicit KernelLoaderSpec(abslx::string_view kernelname);
...
class OnDiskKernelLoaderSpec : public KernelLoaderSpec {
 ...
 protected:
  OnDiskKernelLoaderSpec(abslx::string_view filename,
                         abslx::string_view kernelname);
...
class CudaPtxOnDisk : public OnDiskKernelLoaderSpec {
 public:
  CudaPtxOnDisk(abslx::string_view filename, abslx::string_view kernelname);
...
class CudaCubinOnDisk : public OnDiskKernelLoaderSpec {
 public:
  CudaCubinOnDisk(abslx::string_view filename, abslx::string_view kernelname);
...
class CudaPtxInMemory : public KernelLoaderSpec {
 public:
  ...
  typedef std::tuple<int, int, abslx::string_view> PtxSpec;
  ...
  //
  // Warning: the string backing the provided abslx::string_view ptx must outlive
  // this instance.
  CudaPtxInMemory(abslx::string_view ptx, abslx::string_view kernelname,
  ...
  CudaPtxInMemory(const std::initializer_list<PtxSpec> &spec_list,
                  abslx::string_view kernel_name, bool ptx_compressed = false);
...
class OpenCLTextOnDisk : public OnDiskKernelLoaderSpec {
 public:
  OpenCLTextOnDisk(abslx::string_view filename, abslx::string_view kernelname);
...
class OpenCLBinaryOnDisk : public OnDiskKernelLoaderSpec {
 public:
  OpenCLBinaryOnDisk(abslx::string_view filename, abslx::string_view kernelname);
...
class OpenCLTextInMemory : public KernelLoaderSpec {
 public:
  OpenCLTextInMemory(abslx::string_view text, abslx::string_view kernelname);
...
class CudaCubinInMemory : public KernelLoaderSpec {
 public:
  CudaCubinInMemory(const char *bytes, abslx::string_view kernelname);
...
class MultiKernelLoaderSpec {
 public:
  ...
  // extern "C" scope.
  MultiKernelLoaderSpec *AddOpenCLTextOnDisk(abslx::string_view filename,
                                             abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddOpenCLBinaryOnDisk(abslx::string_view filename,
                                               abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddOpenCLTextInMemory(abslx::string_view ocl_text,
                                               abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddCudaPtxOnDisk(abslx::string_view filename,
                                          abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddCudaCubinOnDisk(abslx::string_view filename,
                                            abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddCudaCubinInMemory(const char *cubin_bytes,
                                              abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddCudaPtxInMemory(abslx::string_view ptx,
                                            abslx::string_view kernelname);
  MultiKernelLoaderSpec *AddCudaCompressedPtxInMemory(
      abslx::string_view ptx, abslx::string_view kernelname);
