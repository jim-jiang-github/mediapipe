...
TEST(KernelStatsUtilsTest, KernelDetailsTokenizer) {
  ...
  abslx::string_view kernel_details_0 = "odd grid:3,2,1";
  ...
  abslx::string_view kernel_details_1 = "block:6,5,4 odd ";
  ...
  abslx::string_view kernel_details_2 = "block:1,2,3 odd grid:4,5,6";
  ...
  abslx::string_view kernel_details_3 = "static_shared:7 dynamic_shared:8";
