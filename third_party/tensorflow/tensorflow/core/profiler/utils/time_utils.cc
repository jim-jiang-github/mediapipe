...
int64_t GetCurrentTimeNanos() {
  // abslx::GetCurrentTimeNanos() is much faster than EnvTime::NowNanos().
  ...
  return abslx::GetCurrentTimeNanos();
}

void SleepForNanos(int64_t ns) { abslx::SleepFor(abslx::Nanoseconds(ns)); }
