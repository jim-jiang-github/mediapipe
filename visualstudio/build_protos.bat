...
mediapipe/tasks/cc/audio/audio_classifier/proto/audio_classifier_options.proto ^
...
mediapipe/tasks/cc/components/calculators/tensor/tensors_to_segmentation_calculator.proto ^
mediapipe/tasks/cc/components/classification_postprocessing_options.proto ^
mediapipe/tasks/cc/components/classifier_options.proto ^
mediapipe/tasks/cc/components/containers/category.proto ^
mediapipe/tasks/cc/components/containers/classifications.proto ^
mediapipe/tasks/cc/components/containers/proto/landmarks_detection_result.proto ^
mediapipe/tasks/cc/components/image_preprocessing_options.proto ^
mediapipe/tasks/cc/components/proto/text_preprocessing_graph_options.proto ^
mediapipe/tasks/cc/components/segmenter_options.proto ^
...
mediapipe/tasks/cc/vision/hand_gesture_recognizer/proto/hand_gesture_recognizer_subgraph_options.proto ^
mediapipe/tasks/cc/vision/hand_landmark/hand_landmark_detector_options.proto ^
...
mediapipe/tasks/cc/vision/image_classification/image_classifier_options.proto ^
mediapipe/tasks/cc/vision/image_segmenter/proto/image_segmenter_options.proto ^
