...
void ConstantSidePacketCalculatorOptions_ConstantSidePacket::set_allocated_classification_list_value(::mediapipe::ClassificationList* classification_list_value) {
  ...
  if (classification_list_value) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(classification_list_value)->GetArena();
...
void ConstantSidePacketCalculatorOptions_ConstantSidePacket::set_allocated_landmark_list_value(::mediapipe::LandmarkList* landmark_list_value) {
  ...
  if (landmark_list_value) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(landmark_list_value)->GetArena();
    if (message_arena != submessage_arena) {
