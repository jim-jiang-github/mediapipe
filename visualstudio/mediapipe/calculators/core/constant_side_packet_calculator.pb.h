...
class ConstantSidePacketCalculatorOptions_ConstantSidePacket PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::ClassificationList* release_classification_list_value();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::LandmarkList* release_landmark_list_value();
...
class ConstantSidePacketCalculatorOptions PROTOBUF_FINAL :
...
inline ::mediapipe::ClassificationList* ConstantSidePacketCalculatorOptions_ConstantSidePacket::_internal_mutable_classification_list_value() {
  if (!_internal_has_classification_list_value()) {
    clear_value();
    set_has_classification_list_value();
    value_.classification_list_value_ = CreateMaybeMessage< ::mediapipe::ClassificationList >(GetArena());
  }
...
inline ::mediapipe::LandmarkList* ConstantSidePacketCalculatorOptions_ConstantSidePacket::_internal_mutable_landmark_list_value() {
  if (!_internal_has_landmark_list_value()) {
    clear_value();
    set_has_landmark_list_value();
    value_.landmark_list_value_ = CreateMaybeMessage< ::mediapipe::LandmarkList >(GetArena());
  }
