...
class FlowLimiterCalculatorOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  inline FlowLimiterCalculatorOptions* New() const final {
    return CreateMaybeMessage<FlowLimiterCalculatorOptions>(nullptr);
  }

  FlowLimiterCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 max_in_queue() const;
  void set_max_in_queue(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_max_in_queue() const;
  void _internal_set_max_in_queue(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int64 in_flight_timeout() const;
  void set_in_flight_timeout(::PROTOBUF_NAMESPACE_ID::int64 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int64 _internal_in_flight_timeout() const;
  void _internal_set_in_flight_timeout(::PROTOBUF_NAMESPACE_ID::int64 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 max_in_queue_;
  ::PROTOBUF_NAMESPACE_ID::int32 max_in_flight_;
  ::PROTOBUF_NAMESPACE_ID::int64 in_flight_timeout_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 FlowLimiterCalculatorOptions::_internal_max_in_flight() const {
  return max_in_flight_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 FlowLimiterCalculatorOptions::max_in_flight() const {
  // @@protoc_insertion_point(field_get:mediapipe.FlowLimiterCalculatorOptions.max_in_flight)
  return _internal_max_in_flight();
}
inline void FlowLimiterCalculatorOptions::_internal_set_max_in_flight(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  max_in_flight_ = value;
}
inline void FlowLimiterCalculatorOptions::set_max_in_flight(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 FlowLimiterCalculatorOptions::_internal_max_in_queue() const {
  return max_in_queue_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 FlowLimiterCalculatorOptions::max_in_queue() const {
  // @@protoc_insertion_point(field_get:mediapipe.FlowLimiterCalculatorOptions.max_in_queue)
  return _internal_max_in_queue();
}
inline void FlowLimiterCalculatorOptions::_internal_set_max_in_queue(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  max_in_queue_ = value;
}
inline void FlowLimiterCalculatorOptions::set_max_in_queue(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int64 FlowLimiterCalculatorOptions::_internal_in_flight_timeout() const {
  return in_flight_timeout_;
}
inline ::PROTOBUF_NAMESPACE_ID::int64 FlowLimiterCalculatorOptions::in_flight_timeout() const {
...
inline void FlowLimiterCalculatorOptions::_internal_set_in_flight_timeout(::PROTOBUF_NAMESPACE_ID::int64 value) {
  _has_bits_[0] |= 0x00000004u;
  in_flight_timeout_ = value;
}
inline void FlowLimiterCalculatorOptions::set_in_flight_timeout(::PROTOBUF_NAMESPACE_ID::int64 value) {
