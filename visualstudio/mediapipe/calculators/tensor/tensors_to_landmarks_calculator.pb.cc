...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fcalculators_2ftensor_2ftensors_5fto_5flandmarks_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 13, sizeof(::mediapipe::TensorsToLandmarksCalculatorOptions)},
};
...
void TensorsToLandmarksCalculatorOptions::SharedCtor() {
...
void TensorsToLandmarksCalculatorOptions::SharedDtor() {
...
::PROTOBUF_NAMESPACE_ID::uint8* TensorsToLandmarksCalculatorOptions::_InternalSerialize(
...
void TensorsToLandmarksCalculatorOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.TensorsToLandmarksCalculatorOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const TensorsToLandmarksCalculatorOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<TensorsToLandmarksCalculatorOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.TensorsToLandmarksCalculatorOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.TensorsToLandmarksCalculatorOptions)
    MergeFrom(*source);
  }
}
...
void TensorsToLandmarksCalculatorOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.TensorsToLandmarksCalculatorOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
