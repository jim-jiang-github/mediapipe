...
class TensorsToLandmarksCalculatorOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  inline TensorsToLandmarksCalculatorOptions* New() const final {
    return CreateMaybeMessage<TensorsToLandmarksCalculatorOptions>(nullptr);
  }

  TensorsToLandmarksCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToLandmarksCalculatorOptions::_internal_num_landmarks() const {
  return num_landmarks_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToLandmarksCalculatorOptions::num_landmarks() const {
...
inline void TensorsToLandmarksCalculatorOptions::_internal_set_num_landmarks(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000001u;
  num_landmarks_ = value;
}
inline void TensorsToLandmarksCalculatorOptions::set_num_landmarks(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToLandmarksCalculatorOptions::_internal_input_image_width() const {
  return input_image_width_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToLandmarksCalculatorOptions::input_image_width() const {
...
inline void TensorsToLandmarksCalculatorOptions::_internal_set_input_image_width(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  input_image_width_ = value;
}
inline void TensorsToLandmarksCalculatorOptions::set_input_image_width(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToLandmarksCalculatorOptions::_internal_input_image_height() const {
  return input_image_height_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToLandmarksCalculatorOptions::input_image_height() const {
...
inline void TensorsToLandmarksCalculatorOptions::_internal_set_input_image_height(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  input_image_height_ = value;
}
inline void TensorsToLandmarksCalculatorOptions::set_input_image_height(::PROTOBUF_NAMESPACE_ID::int32 value) {
