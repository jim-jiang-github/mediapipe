...
class TensorsToSegmentationCalculatorOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  inline TensorsToSegmentationCalculatorOptions* New() const final {
    return CreateMaybeMessage<TensorsToSegmentationCalculatorOptions>(nullptr);
  }

  TensorsToSegmentationCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToSegmentationCalculatorOptions::_internal_output_layer_index() const {
  return output_layer_index_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorsToSegmentationCalculatorOptions::output_layer_index() const {
...
inline void TensorsToSegmentationCalculatorOptions::_internal_set_output_layer_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  output_layer_index_ = value;
}
inline void TensorsToSegmentationCalculatorOptions::set_output_layer_index(::PROTOBUF_NAMESPACE_ID::int32 value) {
