...
class AnnotationOverlayCalculatorOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::Color* release_canvas_color();
...
inline void AnnotationOverlayCalculatorOptions::set_allocated_canvas_color(::mediapipe::Color* canvas_color) {
  ...
  if (canvas_color) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(canvas_color)->GetArena();
