...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fcalculators_2futil_2fcollection_5fhas_5fmin_5fsize_5fcalculator_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 6, sizeof(::mediapipe::CollectionHasMinSizeCalculatorOptions)},
};
...
void CollectionHasMinSizeCalculatorOptions::SharedCtor() {
min_size_ = 0;
}
...
void CollectionHasMinSizeCalculatorOptions::SharedDtor() {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          min_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* CollectionHasMinSizeCalculatorOptions::_InternalSerialize(
...
void CollectionHasMinSizeCalculatorOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.CollectionHasMinSizeCalculatorOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const CollectionHasMinSizeCalculatorOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<CollectionHasMinSizeCalculatorOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.CollectionHasMinSizeCalculatorOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.CollectionHasMinSizeCalculatorOptions)
    MergeFrom(*source);
  }
}
...
void CollectionHasMinSizeCalculatorOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.CollectionHasMinSizeCalculatorOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
