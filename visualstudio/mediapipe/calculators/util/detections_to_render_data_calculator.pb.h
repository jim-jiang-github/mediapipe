...
class DetectionsToRenderDataCalculatorOptions PROTOBUF_FINAL :
...
inline void DetectionsToRenderDataCalculatorOptions::set_text_delimiter(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 text_delimiter_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void DetectionsToRenderDataCalculatorOptions::_internal_set_text_delimiter(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  text_delimiter_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* DetectionsToRenderDataCalculatorOptions::_internal_mutable_text_delimiter() {
  _has_bits_[0] |= 0x00000001u;
  return text_delimiter_.Mutable(::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_text_delimiter_, GetArena());
}
inline std::string* DetectionsToRenderDataCalculatorOptions::release_text_delimiter() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return text_delimiter_.ReleaseNonDefault(nullptr, GetArena());
}
...
inline ::mediapipe::RenderAnnotation_Text* DetectionsToRenderDataCalculatorOptions::_internal_mutable_text() {
  _has_bits_[0] |= 0x00000004u;
  if (text_ == nullptr) {
    auto* p = CreateMaybeMessage<::mediapipe::RenderAnnotation_Text>(GetArena());
    text_ = p;
  }
  return text_;
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void DetectionsToRenderDataCalculatorOptions::set_scene_class(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 scene_class_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void DetectionsToRenderDataCalculatorOptions::_internal_set_scene_class(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  scene_class_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* DetectionsToRenderDataCalculatorOptions::_internal_mutable_scene_class() {
  _has_bits_[0] |= 0x00000002u;
  return scene_class_.Mutable(::mediapipe::DetectionsToRenderDataCalculatorOptions::_i_give_permission_to_break_this_code_default_scene_class_, GetArena());
}
inline std::string* DetectionsToRenderDataCalculatorOptions::release_scene_class() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return scene_class_.ReleaseNonDefault(nullptr, GetArena());
}
