...
class OpenCvVideoEncoderCalculatorOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  inline OpenCvVideoEncoderCalculatorOptions* New() const final {
    return CreateMaybeMessage<OpenCvVideoEncoderCalculatorOptions>(nullptr);
  }

  OpenCvVideoEncoderCalculatorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline void OpenCvVideoEncoderCalculatorOptions::set_codec(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 codec_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void OpenCvVideoEncoderCalculatorOptions::set_video_format(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 video_format_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void OpenCvVideoEncoderCalculatorOptions::_internal_set_video_format(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  video_format_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* OpenCvVideoEncoderCalculatorOptions::_internal_mutable_video_format() {
  _has_bits_[0] |= 0x00000002u;
  return video_format_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* OpenCvVideoEncoderCalculatorOptions::release_video_format() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return video_format_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 OpenCvVideoEncoderCalculatorOptions::_internal_width() const {
  return width_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 OpenCvVideoEncoderCalculatorOptions::width() const {
  // @@protoc_insertion_point(field_get:mediapipe.OpenCvVideoEncoderCalculatorOptions.width)
  return _internal_width();
}
inline void OpenCvVideoEncoderCalculatorOptions::_internal_set_width(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;
  width_ = value;
}
inline void OpenCvVideoEncoderCalculatorOptions::set_width(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 OpenCvVideoEncoderCalculatorOptions::_internal_height() const {
  return height_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 OpenCvVideoEncoderCalculatorOptions::height() const {
  // @@protoc_insertion_point(field_get:mediapipe.OpenCvVideoEncoderCalculatorOptions.height)
  return _internal_height();
}
inline void OpenCvVideoEncoderCalculatorOptions::_internal_set_height(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000010u;
  height_ = value;
}
inline void OpenCvVideoEncoderCalculatorOptions::set_height(::PROTOBUF_NAMESPACE_ID::int32 value) {
