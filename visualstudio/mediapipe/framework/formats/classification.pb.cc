...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fframework_2fformats_2fclassification_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mediapipe::ClassificationList, tensor_index_),
  PROTOBUF_FIELD_OFFSET(::mediapipe::ClassificationList, tensor_name_),
  ~0u,
  1,
  0,
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 13, 21, sizeof(::mediapipe::ClassificationList)},
  { 24, -1, sizeof(::mediapipe::ClassificationListCollection)},
};
...
const char descriptor_table_protodef_mediapipe_2fframework_2fformats_2fclassification_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "pipe.Classification\022\024\n\014tensor_index\030\002 \001("
  "\005\022\023\n\013tensor_name\030\003 \001(\t\"Z\n\034Classification"
  "ListCollection\022:\n\023classification_list\030\001 "
  "\003(\0132\035.mediapipe.ClassificationListB9\n\"co"
  "m.google.mediapipe.formats.protoB\023Classi"
  "ficationProto"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mediapipe_2fframework_2fformats_2fclassification_2eproto = {
  false, false, 413, descriptor_table_protodef_mediapipe_2fframework_2fformats_2fclassification_2eproto, "mediapipe/framework/formats/classification.proto", 
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "mediapipe.ClassificationList.tensor_name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ClassificationList::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_tensor_index(), target);
  }
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "mediapipe.ClassificationList.tensor_name");
    target = stream->WriteStringMaybeAliased(
...
void ClassificationListCollection::SharedCtor() {
}
...
void ClassificationListCollection::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}
...
::PROTOBUF_NAMESPACE_ID::uint8* ClassificationListCollection::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void ClassificationListCollection::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.ClassificationListCollection)
  GOOGLE_DCHECK_NE(&from, this);
  const ClassificationListCollection* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ClassificationListCollection>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.ClassificationListCollection)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.ClassificationListCollection)
    MergeFrom(*source);
  }
}
...
void ClassificationListCollection::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.ClassificationListCollection)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
