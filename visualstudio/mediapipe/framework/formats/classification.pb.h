...
class ClassificationListCollection PROTOBUF_FINAL :
 ...
 public:
  ...
  inline ClassificationListCollection* New() const final {
    return CreateMaybeMessage<ClassificationListCollection>(nullptr);
  }

  ClassificationListCollection* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline void Classification::set_label(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Classification::set_display_name(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
inline ::mediapipe::ClassificationList* ClassificationListCollection::add_classification_list() {
  ...
  return _internal_add_classification_list();
}
