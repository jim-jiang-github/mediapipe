...
class Detection PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::LocationData* release_location_data();
...
inline void Detection::set_feature_tag(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 feature_tag_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void Detection::_internal_set_feature_tag(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  feature_tag_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* Detection::_internal_mutable_feature_tag() {
  _has_bits_[0] |= 0x00000001u;
  return feature_tag_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Detection::set_track_id(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
 track_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void Detection::_internal_set_track_id(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  track_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* Detection::_internal_mutable_track_id() {
  _has_bits_[0] |= 0x00000002u;
  return track_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
