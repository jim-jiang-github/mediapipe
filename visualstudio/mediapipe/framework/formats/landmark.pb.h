...
class LandmarkListCollection PROTOBUF_FINAL :
 ...
 public:
  ...
  inline LandmarkListCollection* New() const final {
    return CreateMaybeMessage<LandmarkListCollection>(nullptr);
  }

  LandmarkListCollection* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class NormalizedLandmarkListCollection PROTOBUF_FINAL :
 ...
 public:
  ...
  inline NormalizedLandmarkListCollection* New() const final {
    return CreateMaybeMessage<NormalizedLandmarkListCollection>(nullptr);
  }

  NormalizedLandmarkListCollection* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::mediapipe::LandmarkList* LandmarkListCollection::add_landmark_list() {
  ...
  return _internal_add_landmark_list();
}
