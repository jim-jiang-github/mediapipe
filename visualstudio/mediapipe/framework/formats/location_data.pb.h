...
class LocationData_BinaryMask PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::Rasterization* release_rasterization();
...
class LocationData PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::LocationData_BoundingBox* release_bounding_box();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::LocationData_RelativeBoundingBox* release_relative_bounding_box();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::LocationData_BinaryMask* release_mask();
...
inline void LocationData_RelativeKeypoint::set_keypoint_label(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 keypoint_label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void LocationData_RelativeKeypoint::_internal_set_keypoint_label(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  keypoint_label_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* LocationData_RelativeKeypoint::_internal_mutable_keypoint_label() {
  _has_bits_[0] |= 0x00000001u;
  return keypoint_label_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
