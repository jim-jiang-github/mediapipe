...
class StatusHandlerConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  inline StatusHandlerConfig* New() const final {
    return CreateMaybeMessage<StatusHandlerConfig>(nullptr);
  }

  StatusHandlerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline void StatusHandlerConfig::set_status_handler(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 status_handler_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void StatusHandlerConfig::_internal_set_status_handler(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  status_handler_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* StatusHandlerConfig::_internal_mutable_status_handler() {
  _has_bits_[0] |= 0x00000001u;
  return status_handler_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* StatusHandlerConfig::release_status_handler() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return status_handler_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
