...
class InputStreamHandlerConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  inline InputStreamHandlerConfig* New() const final {
    return CreateMaybeMessage<InputStreamHandlerConfig>(nullptr);
  }

  InputStreamHandlerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  std::string* release_input_stream_handler();
  ...
  void _internal_set_input_stream_handler(const std::string& value);
...
class OutputStreamHandlerConfig PROTOBUF_FINAL :
 ...
 public:
  ...
  inline OutputStreamHandlerConfig* New() const final {
    return CreateMaybeMessage<OutputStreamHandlerConfig>(nullptr);
  }

  OutputStreamHandlerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  std::string* release_output_stream_handler();
  ...
  void _internal_set_output_stream_handler(const std::string& value);
...
inline void InputStreamHandlerConfig::clear_input_stream_handler() {
  input_stream_handler_.ClearToDefault(::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_, GetArena());
...
inline void InputStreamHandlerConfig::set_input_stream_handler(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 input_stream_handler_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void InputStreamHandlerConfig::_internal_set_input_stream_handler(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  input_stream_handler_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* InputStreamHandlerConfig::_internal_mutable_input_stream_handler() {
  _has_bits_[0] |= 0x00000001u;
  return input_stream_handler_.Mutable(::mediapipe::InputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_input_stream_handler_, GetArena());
}
inline std::string* InputStreamHandlerConfig::release_input_stream_handler() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return input_stream_handler_.ReleaseNonDefault(nullptr, GetArena());
}
...
inline void OutputStreamHandlerConfig::clear_output_stream_handler() {
  output_stream_handler_.ClearToDefault(::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_, GetArena());
  _has_bits_[0] &= ~0x00000001u;
}
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void OutputStreamHandlerConfig::set_output_stream_handler(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 output_stream_handler_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline void OutputStreamHandlerConfig::_internal_set_output_stream_handler(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  output_stream_handler_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArena());
}
inline std::string* OutputStreamHandlerConfig::_internal_mutable_output_stream_handler() {
  _has_bits_[0] |= 0x00000001u;
  return output_stream_handler_.Mutable(::mediapipe::OutputStreamHandlerConfig::_i_give_permission_to_break_this_code_default_output_stream_handler_, GetArena());
}
inline std::string* OutputStreamHandlerConfig::release_output_stream_handler() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return output_stream_handler_.ReleaseNonDefault(nullptr, GetArena());
}
