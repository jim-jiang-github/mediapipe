...
class ThreadPoolExecutorOptions PROTOBUF_FINAL :
 ...
 public:
  ...
  inline ThreadPoolExecutorOptions* New() const final {
    return CreateMaybeMessage<ThreadPoolExecutorOptions>(nullptr);
  }

  ThreadPoolExecutorOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 stack_size() const;
  void set_stack_size(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_stack_size() const;
  void _internal_set_stack_size(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 nice_priority_level() const;
  void set_nice_priority_level(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_nice_priority_level() const;
  void _internal_set_nice_priority_level(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 stack_size_;
  ::PROTOBUF_NAMESPACE_ID::int32 nice_priority_level_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadPoolExecutorOptions::_internal_num_threads() const {
  return num_threads_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadPoolExecutorOptions::num_threads() const {
  // @@protoc_insertion_point(field_get:mediapipe.ThreadPoolExecutorOptions.num_threads)
  return _internal_num_threads();
}
inline void ThreadPoolExecutorOptions::_internal_set_num_threads(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000002u;
  num_threads_ = value;
}
inline void ThreadPoolExecutorOptions::set_num_threads(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadPoolExecutorOptions::_internal_stack_size() const {
  return stack_size_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadPoolExecutorOptions::stack_size() const {
  // @@protoc_insertion_point(field_get:mediapipe.ThreadPoolExecutorOptions.stack_size)
  return _internal_stack_size();
}
inline void ThreadPoolExecutorOptions::_internal_set_stack_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  stack_size_ = value;
}
inline void ThreadPoolExecutorOptions::set_stack_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadPoolExecutorOptions::_internal_nice_priority_level() const {
  return nice_priority_level_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ThreadPoolExecutorOptions::nice_priority_level() const {
...
inline void ThreadPoolExecutorOptions::_internal_set_nice_priority_level(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000008u;
  nice_priority_level_ = value;
}
inline void ThreadPoolExecutorOptions::set_nice_priority_level(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline void ThreadPoolExecutorOptions::set_thread_name_prefix(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 thread_name_prefix_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArena());
...
inline std::string* ThreadPoolExecutorOptions::mutable_thread_name_prefix() {
  ...
  return _internal_mutable_thread_name_prefix();
}
...
inline void ThreadPoolExecutorOptions::_internal_set_thread_name_prefix(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  thread_name_prefix_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline std::string* ThreadPoolExecutorOptions::_internal_mutable_thread_name_prefix() {
  _has_bits_[0] |= 0x00000001u;
  return thread_name_prefix_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ThreadPoolExecutorOptions::release_thread_name_prefix() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return thread_name_prefix_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
