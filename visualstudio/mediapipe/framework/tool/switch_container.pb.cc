...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fframework_2ftool_2fswitch_5fcontainer_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
void SwitchContainerOptions::SharedDtor() {
...
::PROTOBUF_NAMESPACE_ID::uint8* SwitchContainerOptions::_InternalSerialize(
...
void SwitchContainerOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.SwitchContainerOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const SwitchContainerOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<SwitchContainerOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.SwitchContainerOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.SwitchContainerOptions)
    MergeFrom(*source);
  }
}
...
void SwitchContainerOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.SwitchContainerOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
bool SwitchContainerOptions::IsInitialized() const {
  if (!::PROTOBUF_NAMESPACE_ID::internal::AllAreInitialized(contained_node_)) return false;
  return true;
}
