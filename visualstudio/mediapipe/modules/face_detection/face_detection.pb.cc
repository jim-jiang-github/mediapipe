...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_mediapipe_2fmodules_2fface_5fdetection_2fface_5fdetection_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 19, sizeof(::mediapipe::FaceDetectionOptions)},
};
...
void FaceDetectionOptions::SharedCtor() {
model_path_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void FaceDetectionOptions::SharedDtor() {
...
::PROTOBUF_NAMESPACE_ID::uint8* FaceDetectionOptions::_InternalSerialize(
...
void FaceDetectionOptions::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:mediapipe.FaceDetectionOptions)
  GOOGLE_DCHECK_NE(&from, this);
  const FaceDetectionOptions* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<FaceDetectionOptions>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:mediapipe.FaceDetectionOptions)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:mediapipe.FaceDetectionOptions)
    MergeFrom(*source);
  }
}
...
void FaceDetectionOptions::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:mediapipe.FaceDetectionOptions)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
