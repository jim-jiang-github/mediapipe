...
class Environment PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::face_geometry::PerspectiveCamera* release_perspective_camera();
...
inline ::mediapipe::face_geometry::PerspectiveCamera* Environment::_internal_mutable_perspective_camera() {
  ...
  if (perspective_camera_ == nullptr) {
    auto* p = CreateMaybeMessage<::mediapipe::face_geometry::PerspectiveCamera>(GetArena());
...
inline void Environment::set_allocated_perspective_camera(::mediapipe::face_geometry::PerspectiveCamera* perspective_camera) {
  ...
  if (perspective_camera) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(perspective_camera);
