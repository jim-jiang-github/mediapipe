...
class FaceGeometry PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::face_geometry::Mesh3d* release_mesh();
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::MatrixData* release_pose_transform_matrix();
...
inline ::mediapipe::face_geometry::Mesh3d* FaceGeometry::_internal_mutable_mesh() {
  _has_bits_[0] |= 0x00000001u;
  if (mesh_ == nullptr) {
    auto* p = CreateMaybeMessage<::mediapipe::face_geometry::Mesh3d>(GetArena());
    mesh_ = p;
  }
  return mesh_;
}
...
inline ::mediapipe::MatrixData* FaceGeometry::_internal_mutable_pose_transform_matrix() {
  ...
  if (pose_transform_matrix_ == nullptr) {
    auto* p = CreateMaybeMessage<::mediapipe::MatrixData>(GetArena());
...
inline void FaceGeometry::set_allocated_pose_transform_matrix(::mediapipe::MatrixData* pose_transform_matrix) {
  ...
  if (pose_transform_matrix) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(pose_transform_matrix)->GetArena();
    if (message_arena != submessage_arena) {
