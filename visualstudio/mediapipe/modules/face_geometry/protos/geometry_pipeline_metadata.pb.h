...
class WeightedLandmarkRef PROTOBUF_FINAL :
...
class GeometryPipelineMetadata PROTOBUF_FINAL :
 ...
 public:
  ...
  PROTOBUF_FUTURE_MUST_USE_RESULT ::mediapipe::face_geometry::Mesh3d* release_canonical_mesh();
...
inline void GeometryPipelineMetadata::set_allocated_canonical_mesh(::mediapipe::face_geometry::Mesh3d* canonical_mesh) {
  ...
  if (canonical_mesh) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(canonical_mesh)->GetArena();
